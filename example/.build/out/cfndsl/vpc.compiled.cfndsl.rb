    ...
    require('/Users/aaronwalker/.cfhighlander/components/vpc/latest//ext/cfndsl/nacl.rb')

    require('/Users/aaronwalker/.cfhighlander/components/vpc/latest//ext/cfndsl/nat.rb')

    require('/Users/aaronwalker/.cfhighlander/components/vpc/latest//ext/cfndsl/az.rb')

    require('/Users/aaronwalker/.cfhighlander/components/vpc/latest//ext/cfndsl/sg.rb')
...
# render subcomponents
    ...
    CloudFormation_Stack('dnszone') do
        TemplateURL 'https://855280047356.ap-southeast-2.ciinabox.s3.amazonaws.com/cloudformation/ciinabox-example/0.1.0/dnszone.compiled.yaml'
        Parameters ({
        	'EnvironmentName' => {"Ref":"EnvironmentName"},
        	'EnvironmentType' => {"Ref":"EnvironmentType"},
        	'CreateZone' => 'true',
        	'RootDomainName' => {"Fn::Sub":"${DnsDomain}."},
        	'AddNSRecords' => {"Ref":"dnszoneAddNSRecords"},
        	'ParentIAMRole' => {"Ref":"dnszoneParentIAMRole"},
        })
    ...
    Parameter('NetworkPrefix') do
      Type 'String'
      Default '10'
      NoEcho false
    end

    Parameter('StackMask') do
      Type 'String'
      Default '16'
      NoEcho false
    end
    ...
    Parameter('Nat0EIPAllocationId') do
      Type 'String'
      Default 'dynamic'
      NoEcho false
    end
    ...
    Parameter('Nat1EIPAllocationId') do
      Type 'String'
      Default 'dynamic'
      NoEcho false
    end
    ...
    Parameter('Nat2EIPAllocationId') do
      Type 'String'
      Default 'dynamic'
      NoEcho false
    end
    ...
    Parameter('Nat3EIPAllocationId') do
      Type 'String'
      Default 'dynamic'
      NoEcho false
    end
    ...
    Parameter('Nat4EIPAllocationId') do
      Type 'String'
      Default 'dynamic'
      NoEcho false
    end
    ...
    Parameter('MaxNatGateways') do
      Type 'String'
      Default '5'
      NoEcho false
    end

    Parameter('SingleNatGateway') do
      Type 'String'
      Default 'true'
      NoEcho false
    end

    Parameter('dnszoneAddNSRecords') do
      Type 'String'
      Default 'false'
      NoEcho false
    ...
    Parameter('dnszoneParentIAMRole') do
      Type 'String'
      Default ''
      NoEcho false
    end
